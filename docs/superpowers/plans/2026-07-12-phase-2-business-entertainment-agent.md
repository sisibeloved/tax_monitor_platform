...
| `0008b_entertainment_coverage_fields.py` | `0008b_ent_coverage_fields` | `0008a_ent_snapshot_guard` |
| `0009_semantic_contracts_accounts.py` | `0009_semantic_accounts` | `0008b_ent_coverage_fields` |
...
预期：所有命令均通过（PASS）；迁移链为 `0006→0007→0008→0008a→0008b→0009→0010`，且只有一个Alembic迁移头；范围/导入/血缘/schema/安全/合并/聚合测试通过；发布指标达到已审批阈值。
